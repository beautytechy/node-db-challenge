...
Relational databases are databases that store their data in tables. SQL (Structured Query Language) is the standard language used to manage databases and the data within them.
...
We need an intermediary table in order to have a _many to many_ relationship between two tables.
